...
const AddRoom = () => {
    ...
    return (
        <form>
            ...
            details carefully and accure room details carefully and accurate room details, 
            ...
            <div className="w-full flex max:sm:flex-col sm:gap-4 mt-4">
                ...
                <button className="bg-[#2124e8] text-white px-8 py-2 rounded mt-8 cursor-pointer">
                    Add Room
                </button>
        </form>
    )
