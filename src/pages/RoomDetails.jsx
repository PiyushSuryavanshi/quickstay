...
const RoomDetails = () => {
    ...
    return room && (
        <div className="py-28 md:px-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                ...
                <button type='submit' className="bg-[#2124e8] hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer">
                    Check Availability 
                </button>
            ...
            <div className="flex flex-col items-start gap-4">
                ...
                <button className="px-6 py-2.5 mt-4 rounded text-white bg-[#2124e8] hover:bg-primary-dull transition-all cursor-pointer">Contact Now</button>
            </div>
        </div>
    )
}
