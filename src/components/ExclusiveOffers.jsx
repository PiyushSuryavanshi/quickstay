...
const ExclusiveOffers = () => {
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
            ...
            <div className='flex flex-col md:flex-row items-center justifty-between w-full pb-5'>
                ...
                <button className='group flex align-center gap-2 font-medium cursor-pointer pt-5 pb-5 xl:px-5 lg:ml-70'>
                    View All Offfers 
