...
//                 <h1 className="text-4xl md:text-[40px] font-playfair">What Our Guests Say</h1>
//                 <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-[696px]">Discover why discerning travelers consistently choose QuickStay for their exclusive and luxurious accommodations around the world.</p>
//             </div>
